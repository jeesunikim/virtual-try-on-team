...
accelerate launch --num_cpu_threads_per_process=2 "./train_db.py" --enable_bucket \
    ...
    --train_data_dir="/workspace/edeyneka/2023_12_03_hackathon/kate-deyneka/experiment/identity/img" --resolution="512,768" \
    --output_dir="/workspace/edeyneka/2023_12_03_hackathon/kate-deyneka/experiment/identity/model" \
    --logging_dir="/workspace/edeyneka/2023_12_03_hackathon/kate-deyneka/experiment/identity/log" \
    --save_model_as=safetensors --output_name="ohwzperson" --lr_scheduler_num_cycles="8" --max_data_loader_n_workers="0" \
    ...
    --sample_prompts="/workspace/edeyneka/2023_12_03_hackathon/kate-deyneka/experiment/identity/model/sample/prompt.txt" \
