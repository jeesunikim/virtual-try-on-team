...
accelerate launch --num_cpu_threads_per_process=2 "./train_network.py" --enable_bucket \
    --min_bucket_reso=256 --max_bucket_reso=2048 --pretrained_model_name_or_path="/workspace/edeyneka/2023_12_03_hackathon/kate-deyneka/experiment/identity/model/ohwzperson-000007.safetensors" \
    --train_data_dir="/workspace/edeyneka/2023_12_03_hackathon/kate-deyneka/experiment/clothes_try_on/img" \
    --resolution="512,768" \
    --output_dir="/workspace/edeyneka/2023_12_03_hackathon/kate-deyneka/experiment/clothes_try_on/model" \
    --logging_dir="/workspace/edeyneka/2023_12_03_hackathon/kate-deyneka/experiment/clothes_try_on/log" --network_alpha="1" \
